...
describe('upsert', () => {
  ...
  it('Returns an array formed by replacing the first element matching the predicate with the supplied value', () => {
    ...
    chai.expect(replacedArray).to.deep.equal([ant, bear, donkey]);
  });
